...
const EventDashboardPostDetail = () => {
  const [isTypeBtnClicked, setIsTypeBtnClicked] = useState(false)


  return (
    <motion.div layout className={`col-span-10 grid grid-cols-3 gap-10`}>
                ...
                <div className='flex flex-col justify-between'>
                    ...
                    <div onClick={()=>setIsTypeBtnClicked(false)} className='flex flex-col gap-3 px-[14px] overflow-y-scroll'>
                        ...
                        <div className='flex justify-start w-[70%]'>
                            <div className=' bg-[#e7e8f0] p-3 rounded-[20px_15px_15px_10px]'>i&apos;ll just hold u beautiful face and kiss u, like there&apos;s no tomorrow❤️</div> 
...
export default EventDashboardPostDetail
