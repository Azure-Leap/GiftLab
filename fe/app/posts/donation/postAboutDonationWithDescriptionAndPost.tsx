...
const DescriptionPostAboutPaymentWithDescriptionAndPosts = ({clickedPost} : any) => {
  ...
  let percentage = clickedPost.reached/clickedPost.goal*100;
    ...
    <div className='col-span-3 rounded-[32px] row-span-6  flex flex-col gap-5 h-[93vh] overflow-y-scroll relative ' id='top'>
      {/* Top */}
        ...
        <div className='grid grid-cols-2  rounded-[32px] gap-5'>
                <div className='flex flex-col justify-between bg-white p-5 rounded-[32px] gap-5 shadow-[0_0_4px_rgba(0,0,0,0.5)] '>
                  <div className='col-span-1  flex flex-col gap-4  '> 
                    ...
                    <div className='flex gap-1 items-center ms-3'>
                      ...
                      <p className='font-semibold text-[14px]'>{clickedPost.donatedPeople} people donated</p>
                    </div>
                    {/* Event By */}
                    <div className='flex gap-1 items-center ms-3'>
            ...
            <div className='bg-white rounded-[32px] p-[2rem] shadow-[0_0_4px_rgba(0,0,0,0.5)]  '>
