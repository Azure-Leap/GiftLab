...
const SignIn = () => {
  ...
  function isInputContainerClicked (inputRef : any) {
  ...
  return (
    ...
    // ref={inputContainer}
    className='flex items-center justify-center h-[100vh]  bg-[linear-gradient(90deg,#e1e1e1,#a7bfe8)] relative'>
        <div className='grid grid-cols-2  min-h-[40vh] w-[40wv] bg-home-page text-[#777474] rounded-[2rem] p-[3rem_5rem]  relative'>
        {/* <!-- Left side of the form --> */}
        <div className="contact-left">
          <h1 className="text-[#6391e8]">Chiakiiii</h1>
          {/* <p className="description">Do something<br/> to make your partner's life better. </p> */}
          {/* <Typewriter text="Do something" duration={20}/> */}
          {/* <br /> */}
          {/* <Typewriter text={`to make your partner's life better.`}  duration={20}/> */}
          <div className="w-full">
              <Typewriter text="Do something to make your partner's life better." duration={20}/>
          </div>
        ...
        <div className="flex flex-col justify-between">
          ...
          {/* Inputs */}
          {
            loginInputsData.map((input, idx) => <div key={idx}> <Input key={input.name} input={inputRef} inputs={input}/></div>)
          }
          <Typewriter text = 'Otgoo yumaa hiii' duration = {80}/>
          {/* <!-- CheckBox --> */}
          <Checkbox/>

          {/* Sign Up button */}
          <button className='p-[0.5rem_2.5rem] border-none rounded-[0.2rem] font-[500] text-[0.6rem] bg-[#6190e8] text-white mt-[1rem] self-start '>Sign Up</button>
        </div>

        {/* <!-- CHaracter --> */}
        <svg
        className='overflow-visible absolute left-0 top-1/4  scale-[0.7] origin-bottom'
        id="character"
        width="241"
        height="336"
        viewBox="0 0 241 336"
      ...
      <stop offset="1" stop-color="#94B9FF" />
        ...
        {/* <!-- Submitted --> */}
        <div className="absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 text-[#777474] text-[1rem] pointer-events-none text-center opacity-0">
          <p>Thanks for submitting <br />  You wull hear from us soon!</p>
        </div>
    </div>
